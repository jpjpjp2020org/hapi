"""
Django settings for hapiproject project.
...
WSGI_APPLICATION = 'hapiproject.wsgi.application'
...
# # for postgres, if needed - needs ENV variables for decouple
# DATABASES = {
#     'default': {
